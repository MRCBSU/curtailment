...
You can install the released version of curtailment from [CRAN](https://CRAN.R-project.org) with:
...
<!-- sc.subset <- data.frame(n=ns.wald, r=r.wald) -->
 ...
 - Better solution: allow choice of definition of CP
 - make some returned output invisible
 - Fix bug: findSCdesigns and findNSCdesigns won't print plots
 - Make alias of find2stagedesigns to make clear it can obtain Simon designs
...
## To Report
 ...
 - "Breaking" updates to argument names nmin, nmax -- now n.max. 
